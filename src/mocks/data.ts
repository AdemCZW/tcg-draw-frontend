...
export const pools: Pool[] = [
  {
    ...
    prizes: [
      ...
      { id: 'pr4', tier: 'D', card: cards[6], total: 4, remaining: 2 },
      { id: 'pr5', tier: 'D', card: cards[8], total: 73, remaining: 32 },
  ...
  },
  {
    ...
    prizes: [
      ...
      { id: 'pr8', tier: 'B', card: cards[7], total: 5, remaining: 5 },
      { id: 'pr9', tier: 'C', card: cards[8], total: 34, remaining: 34 }
    ]
  },
  {
    sellerId: 's3',
    ...
    prizes: [
      ...
      { id: 'pr11', tier: 'B', card: cards[2], total: 3, remaining: 0 },
      { id: 'pr12', tier: 'C', card: cards[7], total: 56, remaining: 0 }
    ]
  },
  {
    sellerId: 's2',
    ...
    prizes: [
      ...
      { id: 'pr14', tier: 'D', card: cards[8], total: 49, remaining: 40 },
  ...
  },
  {
    ...
    prizes: [
      ...
      { id: 'pr20', tier: 'C', card: cards[5], total: 12, remaining: 9 },
      { id: 'pr21', tier: 'D', card: cards[8], total: 30, remaining: 23 },
      // BUST 的 card 即為保底卡：抽中時沒收暫持獎品，改發這張
  ...
  },
  {
    ...
    prizes: [
      ...
      { id: 'pr24', tier: 'B', card: cards[2], total: 2, remaining: 1 },
      { id: 'pr25', tier: 'C', card: cards[6], total: 7, remaining: 1 },
      { id: 'pr26', tier: 'D', card: cards[8], total: 70, remaining: 0 }
    ]
  }
]
