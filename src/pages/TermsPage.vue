 ...
 *    不可以拿掉。這份文件沒有經過律師。
 *
 * 4) refPrice 一律寫成「賣家標示參考價」，不寫「參考市值」。
 *    a0bcb64 已經把全站的用詞統一成這個 —— 條款如果還叫它「市值」，
 *    就是用一個跟畫面上對不起來的名字去指同一個欄位；而且「市值」本身
 *    暗示有市場行情當依據，跟同一句話後面的「沒有外部依據」互相打架。
 *    這一頁的語意本來就是對的（每一處都同時聲明沒有依據、不參與計算），
 *    改的是用詞不是責任範圍：**不要順手把免責的範圍改寬或改窄**。
 *    第十四節那句的<b>不保證卡片的市場價格</b>要保留「市場價格」——
 *    那才是被免責的對象，換成「參考價」會把免責縮小成只免自家欄位。
 *
  ...
  <div class="container page doc">
    ...
    <section id="t-fair">
      ...
      <ol class="steps">
        ...
        <li>
          ...
          卡號、鑑定機構、鑑定分數、鑑定編號、賣家標示參考價、<b>買回價</b>與<b>卡片版本</b>。
        </li>
        <li>
    ...
    <section id="t-buyback">
      ...
      <ul class="bullets">
        ...
        <li>獎品清單上的「<b>賣家標示參考價</b>」<b>沒有外部依據</b>，是賣家自己填的，也<b>不參與任何金額計算</b>，只是顯示用。真正有約束力的數字是買回價。</li>
    ...
    <section id="t-limits">
      ...
      <ul class="bullets">
        ...
        <li><b>不保證卡片的市場價格</b>。賣家標示的參考價沒有外部依據，也不參與任何計算。</li>
      ...
      <div class="tw">
        <table>
          ...
          <tbody>
            ...
            <tr><td>八・賣家標示參考價不參與計算</td><td class="m">src/shared/pool-settlement.ts:57-66；src/shared/fairness.ts:67</td></tr>
