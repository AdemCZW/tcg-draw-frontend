...
- 社群（內容打底，廣告加速）· 廣告投得出去，變數在素材 —— 擋的是「拿錢換錢」，我們的獎品是實體卡；素材講卡況，不講中獎金額。
- 社群 · 台灣投放先過廣告主驗證 —— 2025 年 1 月起的法定要求，這關由平台跑完，你只要出素材。
- 社群 · 我們發的內容是驗算 —— 完抽後公開種子，任何人都能自己算一次。這是別家抄不走的素材。
- 活動（平台出版位與檔期）· 首發池排程 —— 新賣家的第一個池排進大廳的固定版位，不必一開始就跟老池搶自然排序。
- 活動 · 主題檔期 —— 同一個系列或主題的池集中在同一週開，多個賣家共用一次流量。參不參加你決定。
- 活動 · 開箱合作 —— 平台幫你牽線創作者。業配一律標示清楚（公平交易法），標了反而更有人信。
- 跟店家合作（你的店與你的池互相帶客）· 賣家頁是你的線上門面 —— 開過的池、已出貨卡片、平均出貨天數、糾紛率，跟你的簡介同一頁。
- 跟店家合作 · 池有公開網址 —— 印成 QR 貼在櫃檯、發進你自己的 LINE 群與社團。店裡看到卡，回家抽你的池。
- 跟店家合作 · 你的池只掛你的招牌 —— 一個池屬於一個賣家，客人在你的池頁面不會看到別人的名字。
- 政策查證（2026-09）：Meta 以「投注與獎項含金錢價值」界定博弈，實體商品的抽選包不在明文範圍 —— 是送審歸類問題，不是禁止。台灣投放另需廣告主驗證（2025-01 起）。
